...
* illustrate link:https://github.com/oliviercailloux/java-course/Best practices/[“best” practices] in concrete, simple cases.
...
* Also illustrated: <<JSF-multifield, multi field validation>>.
